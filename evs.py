...
class Administrator():
    ...
    def admin_server(self):
        ...
        print(f"Admin Server running at port : {Administrator.admin_port}")
        print(f"Collector1 initialise at port : {Administrator.collector1_port}")
        print(f"Collector2 initialise at port : {Administrator.collector2_port}")
        server.listen(10)
        voters = []
        votes = []
        while True:    
